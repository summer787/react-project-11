...
function RegistComplete() {
  ...
  return (
    <div className={styles.complete__container}>
      ...
      <h2 className={styles.complete__title}>티빙 회원이 되신 것을 환영해요!</h2>
      <p className={styles.complete__text}>지금 바로 이용권을 구독하고 티빙 오리지널과</p>    
      <p className={`${styles.complete__text} ${styles.complete__text__bottom}`}>최신 인기 TV프로그램, 영화를 무제한으로 만나보세요!</p>
